...
class ProfilesUpdateView(LoginRequiredMixin, PermissionRequiredMixin, UpdateView):
    ...
    def has_permission(self):
        return self.kwargs.get('username') == self.request.user.username or self.request.user.is_superuser
    ...
    def form_valid(self, form):
        ...
        profile.save()
        return redirect(reverse('profiles_app:profiles_detail', kwargs={'username': self.kwargs.get('username')}))
