                    ...
                    try:
                        ...
                        if 'model' in item and 'fields' in item:
                            ...
                            product_data = {
                                ...
                                'created_by_id': fields.get('created_by', request.user.id),
                            }
                            ...
                            product_data = {
                                ...
                                'created_by_id': item.get('created_by', request.user.id),
                            }
                            ...
                            try:
                                ...
                                if os.path.exists(full_path):
                                    ...
                                    with open(full_path, 'rb') as f:
                                        ...
                                        product.preview.save(file_name, django_file, save=True)
                                else:
